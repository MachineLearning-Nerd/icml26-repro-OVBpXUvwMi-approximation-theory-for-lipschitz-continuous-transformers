...
REPOSITORY = "MachineLearning-Nerd/icml26-approximation-theory-lipschitz-continuous-transformers"
...
def main() -> None:
    ...
    assert remote_branches == {
        ...
        "audit/direct-symbolic-proof-certificates",
        "audit/judged-toy-baseline",
        "formal/claims-4-and-5-lean",
        "integration/published-lean-evidence",
        "release/cumulative-evaluator-candidate",
        "release/evaluator-claims-4-and-5",
        "release/release-gated-artifact",
    }, remote_branches
    ...
    print(
        ...
        "claims=C1:C3_verified,C4_verified_medium,C5_verified "
        "historical_score=8/10 current_score_claim=false publication_allowed=false"
    )
